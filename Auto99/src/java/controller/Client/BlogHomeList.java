 ...
 * @author Dao Anh Duc
 */
@WebServlet(name = "BlogHomeList", urlPatterns = {"/bloghomelist"})
public class BlogHomeList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] parentIDs = new String[listbtt.size()];

        for (int i = 0; i < listbtt.size(); i++) {
            Blog b = listbtt.get(i);
        ...
        request.setAttribute("ListTTaKM", listbtt);
        ...
        if (blogIDParam != null) {
            ...
            request.getRequestDispatcher("./Client/BlogHomeList.jsp").forward(request, response);
