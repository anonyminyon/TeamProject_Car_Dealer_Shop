...
public class History extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        CarOrderDAO cardao = new CarOrderDAO();
        Client client = cdao.getClientByEmail(email);
        request.setAttribute("client", client);
        CarDAO DAO = new CarDAO();
        List<CarOrder> clist = cardao.getListCarOrderByEmail(email);
        List<CarIMG> carIMG = DAO.getAllCarIMG();
        request.setAttribute("CarOrderList", clist);
