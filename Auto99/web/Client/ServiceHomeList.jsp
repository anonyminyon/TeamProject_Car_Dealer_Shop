                                    ...
                                    <div class="col-xl-4 col-md-6 service-item">
                                        ...
                                        <div class="down-content">
                                            ...
                                            <div style="display:flex; justify-content: space-between; text-align: center; align-content: center">
                                                ...
                                                <div class="more"><a href="servicehomelist?blogID=${blogID}">${Blog.title.toUpperCase()}</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                            ...
                                            <div class="col-xl-4 col-md-6 service-item">
                                                ...
                                                <div class="down-content">
                                                    ...
                                                    <div style="display:flex; justify-content: space-between; text-align: center; align-content: center">
                                                        ...
                                                        <div class="more"><a href="servicehomelist">${category.blogCategoryID.blogCategory.toUpperCase()}</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                ...
                <c:choose>
                    <c:when test="${endPage <= 7}">
                        <c:forEach begin="1" end="${endPage}" var="i">
                            <c:set var="link" value="servicehomelist?index=${i}" />
                            <c:if test="${blogID != null}">
                    ...
                    <c:otherwise>
                        <c:choose>
                            <c:when test="${index <= 4}">
                                ...
                                <a href="servicehomelist?blogID=${blogID}&index=${endPage}">»</a>
                            </c:when>
                            <c:when test="${index >= endPage - 3}">
                                <a href="servicehomelist?blogID=${blogID}&index=1">«</a>
