            ...
            <div class="container">
                ...
                <div class="app-title">
                    <ul class="app-breadcrumb breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Thêm xe</a></li>
                    </ul>
                </div>
                ...
                <form class="row" action="carcrud" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        <div class="tile">
                            <h3 class="tile-title">Tạo mới xe</h3>
                            <div class="tile-body">
                                    ...
                                    <fieldset class="form-group col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input class="form-control" type="text" name="carName" require="require">
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control" name="statusID">
                                                    <c:forEach items="${status}" var="s">
                                                        <option value="${s.getStatusID()}">${s.getStatusName()}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control" name="designID">
                                                    <c:forEach items="${design}" var="d">
                                                        <option value="${d.getDesignID()}">${d.getDesign()}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input class="form-control" type="text" name="madeIn" require="require">
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input class="form-control" type="text" name="price" require="require" pattern="([0-9]*(\.)?)[0-9]*" title="Xin hãy nhập 1 số thực">
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label class="control-label">Số ghế ngồi </label>
                                                <input class="form-control" type="number" name="seatNumber" require="require">
                                            </div>
                                    ...
                                    <fieldset class="form-group col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input class="form-control" type="text" name="capacity" require="require" require="require" pattern="([0-9]*(\.?)[0-9]*" title="Xin hãy nhập 1 số thực">
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label class="control-label">Loại động cơ </label>
                                                <input class="form-control" type="text" name="engineType" require="require">
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label class="control-label">Số xi lanh </label>
                                                <input class="form-control" type="text" name="cylinderNumber" require="require">
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label class="control-label">Dung tích xi lanh </label>
                                                <input class="form-control" type="text" name="cylinderMaxCapacity" require="require" pattern="([0-9]*(\.)?)[0-9]*" title="Xin hãy nhập 1 số thực">
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input class="form-control" type="text" name="fuelSystem" require="require">
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label class="control-label">Dung tích tối đa </label>
                                                <input class="form-control" type="text" name="fuelCapacity" require="require" pattern="([0-9]+)\/([0-9]+)" title="Hãy nhập theo format số/số">
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label class="control-label">Tốc độ mô-đen xoắn lớn nhất</label>
                                                <input class="form-control" type="text" name="maxTorque" require="require" pattern="([0-9]+)\/([0-9]+)(\-[0-9]+)?" title="Xin hãy nhập theo format số/số hoặc số/số-số">
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label class="control-label">Hộp số</label>
                                                <input class="form-control" type="text" name="gear" require="require">
                                            </div>
