                            ...
                            <div class="container">
                                ...
                                <div class="app-title">
                                    <ul class="app-breadcrumb breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a>Chỉnh sửa nâng cao blog</a></li>
                                    </ul>
                                </div>
                                ...
                                <form class="row" action="blogcrud" method="POST" enctype="multipart/form-data">
                                    <div class="col-md-12">
                                        <div class="tile">
                                            <h3 class="tile-title">Chỉnh sửa nâng cao blog</h3>
                                            <div class="tile-body">
                                                <div class="row">
                                                    <input class="form-control" type="hidden" name="blogID" value="${blogID}" required>
                                            ...
                                            <c:forEach items="${ListPI}" var="c">                                           
                                                <option value="${c.parentID}" <c:if test="${c.parentID == Blog.parentID}"> selected</c:if>>${c.title}</option>
                                            </c:forEach>
                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea class="form-control" name="content" id="default">${Blog.content}</textarea>
                                                    </div>
                                            ...
                                            %>
                                                        ...
                                                        <div class="col-md-4" style="margin-top: 20px;">
                                                            <div id="myfileupload">
                                                                <img id="thumbimage" src="img/Blog/${Blog.blogIMG}" style="max-width: 600px;" />
                                            ...
                                            <input type="hidden" name="action" value="AdvancedUpdateBlog" />
