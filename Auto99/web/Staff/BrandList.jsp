                        ...
                        <div class="container">
                            ...
                            <div class="app-title">
                                <ul class="app-breadcrumb breadcrumb">
                                    <li class="breadcrumb-item"><a href="carlist">Danh sách hãng xe</a></li>
                                    <li class="breadcrumb-item"><a href="brandlist">Danh sách hãng xe</a></li>
                                </ul>
                            </div>
                                    ...
                                    <div class="tile">
                                        <div class="tile-body">
                                            <div class="row element-button">
                                                ...
                                                <div class="col">
                                                    <a class="btn btn-add btn-sm" title="Thêm" id="show-emp" data-toggle="modal" data-target="#ModalUPAddBrand"><i class="fas fa-plus"></i>
                                            Tạo mới hãng xe</a>
                                                </div>
                                            </div>
                                                ...
                                                <tbody>
                                                    <c:forEach var="b" items="${BrandList}">
                                                        <tr>
                                                            ...
                                                            <td><img src="./img/Brand/${b.getBrandIMG()}" alt="" width="120px;"></td>
                                                            <c:if test="${acc != null && acc.getRoleID().getRoleID() == 1}">
                                                            ...
                                                            <td style="text-align: center">
                                                                <button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp" data-toggle="modal" data-target="#ModalUP${b.getBrandID()}"><i class="fas fa-edit"></i></button>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                ...
                                                <div class="col-sm-12 col-md-5">
                                                    <div class="dataTables_info" role="status">
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:when test="${count>0}">
                                                                Hiện ${(index-1)*quantity+1} đến ${((index*(quantity+1))>count) ? count : index*quantity} của ${count} danh mục
                                                            </c:when>
                                                    ...
                                                    <div class="dataTables_paginate">
                                                        <ul class="pagination">
                                                            ...
                                                            <li class="paginate_button page-item previous <c:if test=" ${index==1 } ">disabled</c:if>" id="sampleTable_previous">
                                                                <a href="brandlist?index=${index -1}&name=${name}&quantity=${quantity}" class="page-link">Lùi</a>
                                                            </li>

                                                            <c:forEach begin="1" end="${endPage}" var="i">

                                                                <li class="paginate_button page-item ${index == i?" active ":" "}">
                                                                    <a href="brandlist?index=${i}&name=${name}&quantity=${quantity}" class="page-link">${i}</a>
                                                                </li>

                                                            </c:forEach>

                                                            <li class="paginate_button page-item next <c:if test=" ${index==endPage} ">disabled</c:if>" id="sampleTable_next">
                                                                <a href="brandlist?index=${index +1}&name=${name}&quantity=${quantity}" class="page-link">Tiếp</a>
                                                            </li>
      ...
      MODAL
            -->
                        <c:forEach items="${BrandList}" var="b">
                            <form action="brandlist" method="POST" enctype="multipart/form-data">
                                <div class="modal fade" id="ModalUP${b.getBrandID()}" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <h5>Chỉnh sửa thông tin hãng xe</h5>
                                            </span>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input class="form-control" name="brandName" type="text" required value="${b.getBrandName()}">
                                                    </div>

                                                    <div class="form-group col-md-12">
                                                        <label class="control-label">Ảnh hãng xe</label>
                                                        <img id="imagebox" src="./img/Brand/${b.getBrandIMG()}" alt="" height="450" width="400">
                                                    </div>
            ...
            -->
                        ...
                        <form action="brandlist" method="POST" enctype="multipart/form-data">
                            <div class="modal fade" id="ModalUPAddBrand" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">Tên hãng xe</label>
                                                    <input class="form-control" name="brandName" type="text" required value="">
                                                </div>
            ...
            -->
                ...
                <script>
                    function changeQuantity(selectElement) {
                        ...
                        form.method = 'get';
                        form.action = 'brandlist'; // Set the URL of your servlet
