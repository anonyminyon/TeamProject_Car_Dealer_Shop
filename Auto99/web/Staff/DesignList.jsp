<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@page contentType="text/html" pageEncoding="UTF-8"%>
                        ...
                        <div class="container">
                            ...
                            <div class="app-title">
                                <ul class="app-breadcrumb breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="designlist">Danh sách thiết kế</a></li>
                                </ul>
                            </div>
                                    ...
                                    <div class="tile">
                                        <div class="tile-body">
                                            <div class="row element-button">
                                                ...
                                                <div class="col">
                                                    <a class="btn btn-add btn-sm" title="Thêm" id="show-emp" data-toggle="modal" data-target="#ModalUPAddDesign"><i class="fas fa-plus"></i>
                                            Tạo mới thiết kế</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row search-length">
                                                ...
                                                <div class="col-sm-12 col-md-6 text-lg-right">
                                                    <form action="designlist" method="get">
                                            ...
                                            <table class="table table-hover table-bordered" id="sampleTable">
                                                ...
                                                <tbody>
                                                    <c:forEach var="b" items="${DesignList}">
                                                        <tr>
                                                            <td width="10">
                                                            ...
                                                            <td style="text-align: center">
                                                                <button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp" data-toggle="modal" data-target="#ModalUP${b.getDesignID()}"><i class="fas fa-edit"></i></button>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                    ...
                                                    <div class="dataTables_paginate">
                                                        <ul class="pagination">
                                                            ...
                                                            <li class="paginate_button page-item previous <c:if test=" ${index==1 } ">disabled</c:if>" id="sampleTable_previous">
                                                                <a href="designlist?index=${index -1}&name=${name}&quantity=${quantity}" class="page-link">Lùi</a>
                                                            </li>

                                                            <c:forEach begin="1" end="${endPage}" var="i">

                                                                <li class="paginate_button page-item ${index == i?" active ":" "}">
                                                                    <a href="designlist?index=${i}&name=${name}&quantity=${quantity}" class="page-link">${i}</a>
                                                                </li>

                                                            </c:forEach>

                                                            <li class="paginate_button page-item next <c:if test=" ${index==endPage} ">disabled</c:if>" id="sampleTable_next">
                                                                <a href="designlist?index=${index +1}&name=${name}&quantity=${quantity}" class="page-link">Tiếp</a>
                                                            </li>
      ...
      MODAL
            -->
                        <c:forEach items="${DesignList}" var="b">
                            <form action="designlist" method="POST" enctype="multipart/form-data">
                                <div class="modal fade" id="ModalUP${b.getDesignID()}" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <input type="hidden" name="designID" value="${b.getDesignID()}" />
                                                    <div class="form-group col-md-12">
                                                        <label class="control-label">Tên thiết kế</label>
                                                        <input class="form-control" name="designName" type="text" required value="${b.getDesign()}">
                                                    </div>
                                                ...
                                                <input type="hidden" name="action" value="UpdateDesign" />
            ...
            -->
                        ...
                        <form action="designlist" method="POST" enctype="multipart/form-data">
                            <div class="modal fade" id="ModalUPAddDesign" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">Tên thiết kế</label>
                                                    <input class="form-control" name="designName" type="text" required value="">
                                                </div>
                                            </div>
                                            <BR>
                                            <button class="btn btn-save" type="submit">Lưu lại</button>
            ...
            -->
                ...
                <script>
                    function changeQuantity(selectElement) {
                        ...
                        form.method = 'get';
                        form.action = 'designlist'; // Set the URL of your servlet
