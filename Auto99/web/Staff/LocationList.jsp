                                ...
                                <div class="row element-button">
                                    ...
                                    <div class="col">
                                        <a class="btn btn-add btn-sm" title="Thêm" id="show-emp" data-toggle="modal"
                                           data-target="#ModalUPAddLocation"><i class="fas fa-plus"></i>
                                            Tạo mới hãng xe</a>
                                    </div>
                                </div>
                                ...
                                <div class="row search-length">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="col-sm-12 col-md-6 text-lg-right">
                                            <form action="locationlist" method="get">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp" data-toggle="modal"
                                                            data-target="#ModalUP${b.getLocationID()}"><i class="fas fa-edit"></i></button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        ...
                                        <div class="dataTables_paginate">
                                            <ul class="pagination">
                                                ...
                                                <li class="paginate_button page-item previous <c:if test="${index == 1}">disabled</c:if>" id="sampleTable_previous">
                                                    <a href="locationlist?index=${index -1}&name=${name}&quantity=${quantity}"class="page-link">Lùi</a>
                                                </li>

                                                <c:forEach begin="1" end="${endPage}" var="i">

                                                    <li class="paginate_button page-item ${index == i?"active":""}">
                                                        <a href="locationlist?index=${i}&name=${name}&quantity=${quantity}"class="page-link">${i}</a>
                                                    </li>

                                                </c:forEach>

                                                <li class="paginate_button page-item next <c:if test="${index == endPage}">disabled</c:if>" id="sampleTable_next">
                                                    <a href="locationlist?index=${index +1}&name=${name}&quantity=${quantity}" class="page-link">Tiếp</a>
                                                </li>
      ...
      MODAL
            ...
            <c:forEach items="${LocationList}" var="b">
                <form  action="locationlist" method="POST">
                    <div class="modal fade" id="ModalUP${b.getLocationID()}" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static"
                         data-keyboard="false">
                                    ...
                                    <div class="row">
                                        <div class="form-group  col-md-12">
                                            <span class="thong-tin-thanh-toan">
                                                <h5>Chỉnh sửa thông tin địa điểm</h5>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <input type="hidden" name="locationID" value="${b.getLocationID()}" />
                                        <div class="form-group col-md-12">
                                            <label class="control-label">Tên phí xe</label>
                                            <input class="form-control" name="locationName" type="text" required value="${b.getLocationName()}">
                                        </div>

                                        <div class="form-group col-md-12">
                                            <label class="control-label">Lệ phí trước bạ (%)</label>
                                            <input class="form-control" name="preRegFee" type="number" required value="${b.getPreRegFee()}">
                                        </div>

                                        <div class="form-group col-md-12">
                                            <label class="control-label">Lệ phí đăng kí (VNĐ)</label>
                                            <input class="form-control" name="regFee" type="number" required value="${b.getRegFee()}">
                                        </div>
            ...
            <form  action="locationlist" method="POST">
                <div class="modal fade" id="ModalUPAddLocation" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static"
                     data-keyboard="false">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input class="form-control" name="locationName" type="text" required value="">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label class="control-label">Lệ phí trước bạ (%)</label>
                                        <input class="form-control" name="preRegFee" type="number" required value="">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label class="control-label">Lệ phí đăng kí (VNĐ)</label>
                                        <input class="form-control" name="regFee" type="number" required value="">
                                    </div>
    ...
    MODAL
        ...
        <script>
                function changeQuantity(selectElement) {
                    ...
                    form.method = 'get';
                    form.action = 'locationlist'; // Set the URL of your servlet
