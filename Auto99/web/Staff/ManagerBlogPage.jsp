...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="./assets/Staff/css/StaffsideList.css">
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <h5 class="card-title">Car List <span class="text-muted fw-normal ms-2"></span></h5>
                        </div>
                    </div>
                    <div class="col-md-6">
                                    ...
                                    <tbody>
                                        <c:forEach var="i" items="${listBlog}">
                                            <tr>
                                                ...
                                                <td><span class="badge badge-soft-success mb-0">${i.blogID}</span></td>
                                                <td>${i.title}</td>
                                                <td>${i.datePublish}</td>
                                                <td>
        ...
        </div>        <script src="./assets/js/adminPage.js"></script>
    </body>
</html>
