            ...
            <div class="container">
                ...
                <div class="app-title">
                    <ul class="app-breadcrumb breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Chỉnh sửa phụ tùng</a></li>
                    </ul>
                </div>
                ...
                <form action="partcrud" method="POST"  enctype="multipart/form-data">
                    <div class="col-md-12">
                        <div class="tile">
                            <h3 class="tile-title">Chỉnh sửa phụ tùng</h3>
                            <div class="tile-body">
                                <div class="row">
                                    <fieldset class="form-group col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" name="autoPartID" value="${p.getAutoPartID()}">
                                            <div class="form-group col-md-4">
                                                <label class="control-label">Tên phụ tùng</label>
                                                <input class="form-control" type="text" name="partName" value="${p.getPartName()}" required>
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label class="control-label">Giá tiền (VNĐ) </label>
                                                <input class="form-control" type="number" name="price" value="${p.getPrice()}" required>
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label class="control-label">Tình trạng </label>
                                                <select class="form-control" name="Status">
                                                    <option value="${p.isStatus()}">${p.isStatus()?"Còn sản phẩm":"Hết sản phẩm"}</option>
                                                    <option value="${!p.isStatus()}">${!p.isStatus()?"Còn sản phẩm":"Hết sản phẩm"}</option>
                                                </select>
                                            </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button class="btn btn-primary btn-sm trash" type="button" title="Xóa"
                                                                            onclick="Delete(this, event)" value="${c.getCarID()}">
